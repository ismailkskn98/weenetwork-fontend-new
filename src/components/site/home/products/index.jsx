  ...
  return (
    <section id="products" className="pb-20 lg:pb-24">
      <div>
        ...
        <MotionScrollInView className="mt-8 space-y-5 lg:mt-10">
          <article id="products-weecard" className="grid overflow-hidden rounded-[28px] border border-border-soft bg-surface-warm p-2 lg:grid-cols-[1fr_1.2fr]">
            <article className="flex flex-col justify-between rounded-[22px] bg-white p-7 sm:p-9">
              <div className="flex flex-col">
                <div className="flex size-12 items-center justify-center rounded-2xl bg-surface-warm">
                  <Image src="/images/weeCardPreview.webp" alt="" width={100} height={100} className="size-8 object-contain" />
                </div>
            ...
            <div className="relative flex overflow-hidden rounded-[22px] max-h-133.75">
              ...
              <MotionScrollInViewOpacity className="relative flex-1 flex items-start w-full overflow-hidden pt-8">
                <div className="relative bg-white -rotate-8 mt-6 translate-x-1/5 rounded-[20px] aspect-280/569 w-full max-w-70 overflow-hidden z-10">
                  <Image src="/images/weeCardProfileOne.webp" alt="WeeCard dark profile preview" fill className="object-center rounded-[20px] border-[3px] border-white" />
                </div>
                <div className="relative bg-white rounded-[20px] aspect-310/630 w-full max-w-77.5 scale-110 overflow-hidden z-20 ">
                  <Image src="/images/weeCardProfileTwo.webp" alt="WeeCard baby shop profile preview" fill className="object-center rounded-[20px] border-[3px] border-white" />
                </div>
                <div className="relative bg-white rotate-8 mt-6 -translate-x-1/5 rounded-[20px] aspect-280/569 w-full max-w-70 overflow-hidden z-30 ">
                  <Image src="/images/weeCardProfileThree.webp" alt="WeeCard blue profile preview" fill className="object-center rounded-[20px] border-[3px] border-white" />
                </div>
          ...
          <article id="products-weemenu" className="grid overflow-hidden rounded-[28px] border border-border-soft bg-surface-warm p-2 lg:grid-cols-[1.2fr_1fr]">
            <div className="relative flex overflow-hidden rounded-[22px] max-h-133.75">
              ...
              <MotionScrollInViewOpacity className="relative flex-1 flex items-start w-full overflow-hidden pt-8">
                <div className="relative bg-white -rotate-8 mt-6 translate-x-1/5 rounded-[20px] aspect-280/569 w-full max-w-70 overflow-hidden z-30">
                  <Image src="/images/weeMenuClassic.webp" alt="WeeMenu classic profile preview" fill className="object-center rounded-[20px] border-[3px] border-white" />
                </div>
                <div className="relative bg-white rounded-[20px] aspect-310/630 w-full max-w-77.5 scale-110 overflow-hidden z-20 ">
                  <Image src="/images/weeMenuDefault.webp" alt="WeeMenu default profile preview" fill className="object-center rounded-[20px] border-[3px] border-white" />
                </div>
                <div className="relative bg-white rotate-8 mt-6 -translate-x-1/5 rounded-[20px] aspect-280/569 w-full max-w-70 overflow-hidden z-10">
                  <Image src="/images/weeMenuBurger.webp" alt="WeeMenu burger profile preview" fill className="object-center rounded-[20px] border-[3px] border-white" />
                </div>
              </MotionScrollInViewOpacity>
            </div>
            ...
            <div className="flex flex-col justify-between order-1 rounded-[22px] bg-white p-7 sm:p-9 lg:order-2">
              <div className="flex flex-col items-start rounded-[22px] overflow-hidden max-h-133.75">
                <div className="flex size-12 items-center justify-center rounded-2xl bg-surface-warm">
                  <Image src="/images/weeMenuPreview.webp" alt="" width={100} height={100} className="size-8 object-contain" />
                </div>
            ...
            <div className="flex flex-col justify-between rounded-[22px] bg-white p-7 sm:p-9">
              <div className="flex flex-col items-start">
                <div className="flex size-12 items-center justify-center rounded-2xl bg-surface-soft">
                  <Image src="/images/weeCatalogPreview.webp" alt="" width={100} height={100} className="size-8 object-contain" />
                </div>
